...
// 收藏歌单,t:类型,1:收藏,2:取消收   藏
export const setSubscribe = (id,t) => get('/playlist/subscribe', {id,t,timestamp: Date.now()})

// 获取完整歌单数据
export const getPlaylistAll = (ids) => get('/song/detail', {ids})
